      ...
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex-1 max-w-xl mx-8">
          <div class="relative">
            ...
            <div
              v-if="isSearchFocused && searchQuery && filteredArticles.length > 0"
            ...
            >
              <ul class="py-2">
                <li
                  ...
                  :key="article.id"
                  @mousedown="navigateToArticle(article.slug)"
        ...
        <div class="flex items-center space-x-4">
          ...
          <button
            @click="toggleTheme"
            class="p-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
          ...
          <div class="relative">
            ...
            <!-- Language Menu -->
            <div
              v-if="isLanguageMenuOpen && !isTranslating"
